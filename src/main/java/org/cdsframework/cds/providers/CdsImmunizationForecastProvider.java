...
public class CdsImmunizationForecastProvider {
    ...
    private static final Invocation.Builder FHIR_REQUEST = ClientBuilder
            .newClient()
            .target(
                    "http://baseconverterservice"
                            + "/path1"
                            + "/path2")
    ...
    public Parameters postParameters(
            @OperationParam(name = "assessmentDate") DateType assessmentDate,
            @OperationParam(name = "gender") Enumeration<Enumerations.AdministrativeGender> gender,
            @OperationParam(name = "birthDate") DateType birthDate,
            @OperationParam(name = "immunization") List<Immunization> immunization) {

        CDSInput cdsInput = getCdsInput(gender, birthDate, immunization);
    ...
    private CDSInput getCdsInput(Enumeration<Enumerations.AdministrativeGender> gender, DateType birthDate, List<Immunization> immunization) {
        return null;
    }
    ...
    private Parameters getParametersOut(CDSOutput cdsOutput, List<Immunization> immunization) {
        ...
        // recommendations
        ImmunizationRecommendation immunizationRecommendation = getImmunizationRecommendation(cdsOutput);
        ...
        // evaluations
        List<ImmunizationEvaluation> immunizationEvaluations = getImmunizationEvaluations(cdsOutput, immunization);
    ...
    private List<ImmunizationEvaluation> getImmunizationEvaluations(CDSOutput cdsOutput, List<Immunization> immunization) {
